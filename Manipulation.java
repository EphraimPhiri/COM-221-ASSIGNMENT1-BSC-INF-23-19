...
class Manipulation {
   ...
   public static void AccountManipulation(StudentLoanAccount Student) {
        System.out.println();
   ...
   public static void LoanMenu(StudentLoanAccount Student){
        System.out.println("\n   LOAN MENU " + 
                       "\n__________________");
        System.out.println( 
       "1. Apply For Loan " +
       ...
       "\n4. Logout");
        ...
        switch (option) {
            ...
            case 4: System.out.println(Student.getName() +  "\n<<<<<<<<<<<Logging out>>>>>>>>>>>...");
                    StudentLoanManagementSystem.main(null);
        ...
        switch (key) {
            ...
            case 3: 
                ...
                if(isUndergraduate){
                    ...
                    ((Undergraduate)Student).applyForStationaryLoan(input.nextDouble());   
                }
        ...
        switch (option) {
            ...
            case 3: 
                ...
                if(isUndergraduate){
                    ...
                    ((Undergraduate)Student).payBackStationaryLoan(input.nextDouble());;   
                }
