    ...
    public static void ListAllAccounts() {
        ...
        if(StudentLoanAccount.loanAccounts.isEmpty()){
            ...
            for(int i =0; i<StudentLoanAccount.loanAccounts.size(); i++){
                System.out.printf("%6s \t\t %12.2f", StudentLoanAccount.loanAccounts.get(i).getAccountNumber(),
                                    StudentLoanAccount.loanAccounts.get(i).getTotalLoans() );
                System.out.println();
            }
        }
        System.out.println("\n---------------------------------------------------");
    ...
    if(choice ==1 ||choice ==2){
        ...
        if(choice ==1){
            ...
            // creating and Adding  the account to the array list defined in the super class
             ...
             StudentLoanAccount.loanAccounts.add(new Undergraduate(name, programEnrolled, currentyear));
                System.out.println("\n__________!!Account Created Succesfully!!__________" + 
                    ...
                    "\n----Your Account Number is: " + StudentLoanAccount.loanAccounts.get( StudentLoanAccount.loanAccounts.size() -1 ).getAccountNumber());
        ...
        // Creating Postgraduate account
            ...
            // creating and adding  the account to the array list defined in the super class
                ...
                StudentLoanAccount.loanAccounts.add(new Postgraduate(name, programEnrolled, currentyear));
                System.out.println("\n__________!!Account Created Succesfully!!__________" + 
                    "\n---Your Account Number is: " + StudentLoanAccount.loanAccounts.get( StudentLoanAccount.loanAccounts.size() -1 ).getAccountNumber());
                    System.out.println("---Go to main menu to log in to your account---");
                    System.out.println("----------------------------------------------------------");
...
public static void accountLogin(){
    ...
    // Searches the account number and if found directs to loan manipulation menu
        ...
        for(int i=0; i<StudentLoanAccount.loanAccounts.size() ; i++){
            ...
            if(accountNum.equals(StudentLoanAccount.loanAccounts.get(i).getAccountNumber())){
        ...
        if(isAccountPresent){
            ...
            Manipulation.AccountManipulation(StudentLoanAccount.loanAccounts.get(accountIndex));
            main(null);
        }
